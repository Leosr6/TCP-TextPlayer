...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void LoadFileMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoadFileMenuActionPerformed
        ...
        //Setting filter to allow the opening of *.txt files only
        ...
        if (op == JFileChooser.APPROVE_OPTION)
        {
            ...
            if (handler.exists())
            {
                //FileManager manager = new FileManager(handler);
                //textFromFile = manager.loadFromFile();
                textFromFile.add("eai galera");
                textFromFile.add("eh noixxxx");
                displayText(textFromFile);
            }
        }       
